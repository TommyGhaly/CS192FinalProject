...
class Electronics(Product):
    def __inti__(self, name:str, price:float, description:str, stock_quantity:int, brand:str, model:str, warranty_period:int):
        super().__init__('electronic', name, price, description, stock_quantity)
        self.brand = brand
        self.model = model
